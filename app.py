...
st.markdown("<h2 style='text-align:center; color:#00FF00; font-weight:900; margin-bottom:5px;'>베리타스 메디컬 코어 AI 진단센터</h2>", unsafe_allow_html=True)
